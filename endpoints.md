...
- **Ejemplo**: `.../ws.php?action=login&username=tusuario&password=tupassword`

### Registro
- **Parámetros**: `username`, `name`, `lastname`, `password`, `email`, `gender` (M/F), `def_lang` (ESP/ENG)
- **Ejemplo**: `.../ws.php?action=register&username=pepe&name=Jose&lastname=Garcia&password=1234&email=pepe@mail.com&gender=M&def_lang=ESP`
